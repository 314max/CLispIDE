...
// CLispIDE.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCLispIDE_App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCLispIDE_App

CCLispIDE_App::CCLispIDE_App()
{
...
// Единственный объект CCLispIDE_App

CCLispIDE_App theApp;


// инициализация CCLispIDE_App

BOOL CCLispIDE_App::InitInstance()
{
